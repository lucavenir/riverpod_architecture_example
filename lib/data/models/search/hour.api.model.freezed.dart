...
HourApiModel _$HourApiModelFromJson(Map<String, dynamic> json) {
  return _HourApiModel.fromJson(json);
}
...
mixin _$HourApiModel {
  ...
  int? get isDay =>
      throw _privateConstructorUsedError; // TODO: decouple this one out
...
/// @nodoc
abstract class $HourApiModelCopyWith<$Res> {
  factory $HourApiModelCopyWith(
          HourApiModel value, $Res Function(HourApiModel) then) =
      _$HourApiModelCopyWithImpl<$Res, HourApiModel>;
  @useResult
  $Res call(
      {int? timeEpoch,
      String? time,
...
/// @nodoc
class _$HourApiModelCopyWithImpl<$Res, $Val extends HourApiModel>
    implements $HourApiModelCopyWith<$Res> {
  _$HourApiModelCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$HourApiModelImplCopyWith<$Res>
    implements $HourApiModelCopyWith<$Res> {
  factory _$$HourApiModelImplCopyWith(
          _$HourApiModelImpl value, $Res Function(_$HourApiModelImpl) then) =
      __$$HourApiModelImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {int? timeEpoch,
...
/// @nodoc
class __$$HourApiModelImplCopyWithImpl<$Res>
    extends _$HourApiModelCopyWithImpl<$Res, _$HourApiModelImpl>
    implements _$$HourApiModelImplCopyWith<$Res> {
  __$$HourApiModelImplCopyWithImpl(
      _$HourApiModelImpl _value, $Res Function(_$HourApiModelImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$HourApiModelImpl(
      freezed == timeEpoch
          ? _value.timeEpoch
          : timeEpoch // ignore: cast_nullable_to_non_nullable
              as int?,
...
/// @nodoc
@JsonSerializable()
class _$HourApiModelImpl implements _HourApiModel {
  const _$HourApiModelImpl(
      this.timeEpoch,
      this.time,
      this.tempC,
      this.tempF,
  ...
  factory _$HourApiModelImpl.fromJson(Map<String, dynamic> json) =>
      _$$HourApiModelImplFromJson(json);
...
// TODO: decouple this one out
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$HourApiModelImplCopyWith<_$HourApiModelImpl> get copyWith =>
      __$$HourApiModelImplCopyWithImpl<_$HourApiModelImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$HourApiModelImplToJson(
      this,
    );
  }
}

abstract class _HourApiModel implements HourApiModel {
  const factory _HourApiModel(
      final int? timeEpoch,
      final String? time,
      final double? tempC,
      final double? tempF,
      ...
      final double? gustMph,
      final double? gustKph,
      final double? uv) = _$HourApiModelImpl;

  factory _HourApiModel.fromJson(Map<String, dynamic> json) =
      _$HourApiModelImpl.fromJson;
  ...
  @override
  int? get isDay;
  @override // TODO: decouple this one out
